...
namespace WFapp
{
    internal static class Program
    {
        ...
        private static readonly NationalTeamUtils nationalTeamUtis = new();
        /// <summary>
        ...
        static void Main()
        {
            ...
            Application.Run(new InitialForm(genderLanguageDependency, championshipUtilsDependency, nationalTeamUtis));
        }
    }
}